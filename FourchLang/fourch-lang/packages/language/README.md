...
- [src/fourch-lang.langium](src/fourch-lang.langium) -  The grammar definition of your language
- [src/fourch-lang-module.ts](src/fourch-lang-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/fourch-lang-validator.ts](src/fourch-lang-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/fourch-lang.monarch.ts](src/syntaxes/fourch-lang.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/fourch-lang.tmLanguage.json](syntaxes/fourch-lang.tmLanguage.json) - Textmate based syntax highlighting instructions.
